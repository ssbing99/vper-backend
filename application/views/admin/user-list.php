...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url('admin/view-user'); ?>">Customer's</a></li>
        </ol>
    </section>
            ...
            <div class="col-12">
                ...
                <div class="box padding-0">
                    ...
                    <div class="box-header">
                        <div class="row">       
                            <div class="col-sm-5">    
                                <h3 class="box-title">All Customer's</h3>
                            </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <form>
                                    <select name="status" class="changeallstatus"  date-url="<?php echo base_url('admin/change_status');?>">
                                      ...
                                      <div class="col-sm-6">
                                <button class="btn btn-social-icon btn-circle checkalldelete" data-toggle="modal" data-target="#modal-primary" value="" date-url="<?php echo base_url('admin/deleteUser').'?method='."user-list"; ?>"><i class="glyphicon glyphicon-trash"></i></button>
                            </div>
                                  </div>
                            </div>
                        </div>
                        ...
                        <table class="table table-hover table-responsive">
                            ...
                            <tr>
                                ...
                                if (!empty($arrview)) {
                                    ...
                                    <td><a href="<?php echo base_url('admin/user-detail').'/'.$arrviewobj->id;?>"><?php echo $arrviewobj->fname . " " . $arrviewobj->lname; ?></a></td>
                                    ...
                                    <td>
                                        <button class="btn btn-social-icon btn-circle deleteUser" data-toggle="modal" data-target="#modal-primary" value="<?= $arrviewobj->id; ?>" data-url="<?php echo base_url('admin/deleteUser') . '?deleteid='. $arrviewobj->id; ?>"><i class="glyphicon glyphicon-trash"></i></button>
